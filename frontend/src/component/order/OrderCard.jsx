...
const classes = useStyles();
  ...
  const addToCartHandler = (id , qty = 0) => {
    ...
    alert.success("Articolo aggiunto al carrello")
    history.push("/cart")
  }
            ...
            <div className={classes.secondBlock_left}>
              <div className={classes.productDetailsContainer}>
                ...
                <div>
                  ...
                  <Typography variant="body2" className={classes.productQty}>
                    <strong>Taglia:</strong> {product.selectedSize}
                  </Typography>
                  <Typography variant="body2" className={classes.productQty}>
                    ...
                    >
                      <strong>Stato della consegna:</strong>{" "}
                      <span
                        style={{
                          color:
                    ...
                    {item.shippingCode && (
                      <Typography
                        ...
                        className={classes.deliveryStatus}
                      >
                        <strong>Codice di spedizione:</strong>{" "}
              ...
              <div style={{ padding: "1rem" }}>
                ...
                >
                  ...
                  Scrivere la recensione di un prodotto
                </Button>
