...
function Header() {
  ...
  const { logoUrl, logoWidth, logoHeight } = useSelector((state) => state.siteLogo || {});
      ...
      <div className="header">
        <div className="headerTop">
          <div className="headerTopLeft">
            <p>Offriamo la spedizione gratuita </p>
          </div>
          <div className="headerTopRight">
            <div className="headerRetailer">
              ...
              <span>BENVENUTI IN {shopName}</span>
            </div>
          ...
          {!searchBarActive && (
            <Link to="/">
              <img
                ...
                style={{ 
                  width: logoWidth ? `${logoWidth}px` : '180px',
                  height: logoHeight ? `${logoHeight}px` : '60px',
                  objectFit: 'contain',
                  maxWidth: '100%',
                  maxHeight: '100%',
