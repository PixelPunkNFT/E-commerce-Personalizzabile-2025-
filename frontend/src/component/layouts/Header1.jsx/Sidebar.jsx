      ...
      <ul className="sidebar-menu">
        ...
        >
          <li className="sidebar-menu-item">
            ...
            <span className="sidebar-menu-item-text">Prodotti</span>
          </li>
        </Link>
        <Link
          to="/contact"
        ...
        >
          <li className="sidebar-menu-item">
            ...
            <span className="sidebar-menu-item-text">Contatti</span>
          </li>
        </Link>
        <Link
          to="/about_us"
        ...
        >
          <li className="sidebar-menu-item">
            ...
            <span className="sidebar-menu-item-text">Chi Siamo</span>
          </li>
        </Link>
        <Link
          to="/account"
