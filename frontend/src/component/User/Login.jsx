        ...
        <div className={classes.formContainer}>
          <form className={classes.form}>
            ...
            <Grid container className={classes.rememberMeContainer}>
              <Grid item>
                <FormControlLabel
                  control={<Checkbox color="textPrimary" />}
                  label="Remember me"
                />
              </Grid>
              <Grid item>
            ...
            >
              Accetto i Termini di utilizzo del nostro E-commerce e riconosco che il nostro E-commerce utilizzerà le mie informazioni in conformità con le sue
