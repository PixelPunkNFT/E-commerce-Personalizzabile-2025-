...
import {
 ...
 const useStyles = makeStyles((theme) => ({ payemntPage: {
    padding: "1rem 0",
    width: "100%",
...
const PaymentComponent = () => {
  ...
  const address = `${shippingInfo.address} , ${shippingInfo.city} ${
    shippingInfo.state
  } , ${shippingInfo.pinCode} , ${shippingInfo.country || "italia"}`;
  ...
  const paymentData = {
    ...
    productId: cartItems[0].productId // Prendiamo il primo prodotto come riferimento
  };
    ...
    try {
      ...
      if (result.error) {
        ...
        if (result.paymentIntent.status === "succeeded") {
          ...
          alert.error("Si è verificato un problema durante l'elaborazione del pagamento");
        }
      }
    } catch (error) {
          ...
          <div className={classes.paymentPage__container}>
            <div className={classes.PaymentBox}>
              ...
              >
                ...
                I pagamenti sono crittografati SSL in modo che la tua carta di credito e il pagamento
                i dettagli restano al sicuro.
              </Typography>
              ...
              >
                Facendo clic su "Effettua ordine", accetti i nostri
            ...
            <div className={classes.payemntAmount}>
              <div className="order_summary">
                <h4>
                Riepilogo dell'ordine &nbsp; ( {cartItems.length}{" "}
              ...
              <div className={classes.order_Details}>
                <h5 className={classes.orderSub_heading}>DETTAGLI ORDINE</h5>
                {cartItems &&
